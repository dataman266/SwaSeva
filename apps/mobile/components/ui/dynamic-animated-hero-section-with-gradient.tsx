...
const HeroSection = () => {
  useEffect(() => {
    // querySelectorAll typed as SVGPathElement so getTotalLength() is available
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-black text-white font-sans overflow-hidden relative">
        ...
        <div className="container text-center z-10 relative p-10 animate-fadeIn">
          ...
          <button className="mt-10 px-10 py-4 bg-white text-black border-none rounded cursor-pointer text-xl transition-all duration-300 ease-in-out hover:shadow-[0_0_20px_rgba(255,255,255,0.5)] hover:-translate-y-0.5 shadow-[0_0_10px_rgba(255,255,255,0.2)] hover:scale-105 pulse-animation">
            Start building
          </button>
        </div>
        ...
        {/* Scrolling diagonal pattern — two offset layers for seamless tile */}
        <div
          className="absolute w-[200%] h-[200%] animate-patternScroll"
          style={{
            top: '-50%',
            left: '-50%',
