  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ bottom: 'calc(60px + env(safe-area-inset-bottom, 0px))', background: 'rgba(10,22,10,0.72)', backdropFilter: 'saturate(160%) blur(24px)', WebkitBackdropFilter: 'saturate(160%) blur(24px)', borderTop: '1px solid rgba(74,140,42,0.18)', paddingBottom: '12px', zIndex: 30 }}
      >
